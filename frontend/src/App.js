    ...
    <AuthProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          />
          <Route path="/overview" element={<ProtectedRoute page="overview"><Layout><CommandCentre /></Layout></ProtectedRoute>} />
          ...
          <Route path="/manufacturer-orders" element={<ProtectedRoute page="manufacturer-orders"><Layout><ManufacturerOrders /></Layout></ProtectedRoute>} />
